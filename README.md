...
To resolve `java.lang.OutOfMemoryError` issue, modify `/usr/bin/d2j-dex2jar` file by increasing the heap size specified in `-Xms` and `-Xmx` parameters, for example:
